...
public class DownloaderTaskFragment extends Fragment {
	...
	private final String TAG_FRIEND_RES_IDS = "friends";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> mArguments = this.getArguments().getIntegerArrayList(TAG_FRIEND_RES_IDS);
		Integer[] mArgs = (Integer[])mArguments.toArray(new Integer[mArguments.size()]);



		// TODO: Start the DownloaderTask
		mDownloaderTask.execute(mArgs);
	...
	public class DownloaderTask extends AsyncTask<Integer, Integer, String[]> {
		@Override
		protected String[] doInBackground(Integer... reID) {
			return downloadTweets(reID);
