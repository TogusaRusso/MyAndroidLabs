...
public class ActivityOne extends Activity {
    ...
    //final TextView mTvCreate = (TextView) findViewById(R.id.create);
    //final TextView mTvRestart = (TextView) findViewById(R.id.restart);
    //final TextView mTvStart = (TextView) findViewById(R.id.start);
    //final TextView mTvResume = (TextView) findViewById(R.id.resume);
    TextView mTvCreate;
    TextView mTvRestart;
    TextView mTvStart;
    TextView mTvResume;
